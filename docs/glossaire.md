...
**JustBan** — Registre public des interdictions de gérer, accessible sur [juridat.be](https://www.juridat.be). Les données sont conservées trente ans après la fin de l'interdiction.
...
**Période suspecte** — Période précédant le jugement déclaratif pendant laquelle certains actes du failli peuvent être annulés par le curateur : paiements préférentiels de dettes non échues (six mois avant la faillite), paiements par moyens anormaux (dix jours avant), constitution de sûretés pour des dettes existantes (six mois avant), donations ou ventes à prix dérisoire. Pour le détail, consultez [la période suspecte et les nullités en faillite](comprendre/periode-suspecte.md).
