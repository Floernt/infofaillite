...
Dès que vous avez connaissance du jugement, relevez le nom et les coordonnées du curateur désigné, le nom du juge-commissaire et le numéro de dossier REGSOL. Ces informations sont publiées sur [REGSOL](https://www.regsol.be) dans le premier jour ouvrable qui suit le jugement. Conservez-les dans un endroit accessible.
...
!!! tip "Reconnaissez honnêtement les causes de la faillite"
...
Votre dossier de faillite est accessible sur [REGSOL](https://www.regsol.be) via votre eID ou itsme. Vous pouvez y consulter les rapports du curateur, les procès-verbaux de vérification des créances et les jugements. Prenez l'habitude de le consulter régulièrement pour rester informé de l'avancement de votre procédure.
