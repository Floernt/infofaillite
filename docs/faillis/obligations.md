...
Si le tribunal estime que vous avez commis des fautes graves et caractérisées ayant contribué à la faillite — parmi lesquelles la non-collaboration avec le curateur — il peut refuser totalement ou partiellement [l'effacement automatique de vos dettes à la clôture](effacement.md). C'est l'une des conséquences les plus lourdes pour un indépendant ou un commerçant, car elle prive du bénéfice du nouveau départ.
