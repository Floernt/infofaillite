...
Pour comprendre comment le curateur examine les créances lors des procès-verbaux, consultez d'abord [la vérification des créances et les procès-verbaux](verification-contestation.md).
...
Je vous recommande de rassembler l'ensemble de vos preuves avant d'engager la procédure : factures originales, contrats signés, bons de livraison, correspondances (emails, courriers), mises en demeure, et tout extrait de comptabilité disponible. La solidité de votre dossier déterminera l'issue.

!!! warning "Évaluez le rapport coût-bénéfice avant d'agir"
    Engager une procédure judiciaire a un coût réel — frais d'avocat, frais de justice, et risque d'être condamné aux dépens si vous perdez. Si le montant contesté est modeste, il peut être plus raisonnable d'accepter l'admission partielle que de lancer une procédure longue et coûteuse. Consultez un avocat spécialisé en insolvabilité pour évaluer vos chances avant de vous lancer.
...
!!! danger "Délai strict : un mois après la publication du procès-verbal"
