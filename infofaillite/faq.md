...
Vous êtes créancier d'une entreprise déclarée en faillite et vous vous interrogez sur vos droits, vos démarches ou vos chances de récupérer vos fonds. Cette page rassemble les questions que je reçois le plus souvent, avec des réponses directement actionnables.
...
La source la plus fiable et la plus rapide est le registre [REGSOL](https://www.regsol.be) : en recherchant par nom d'entreprise ou par numéro BCE, vous obtenez immédiatement la date du jugement et les coordonnées du curateur désigné. La faillite est également publiée au Moniteur belge dans les cinq jours suivant le jugement, ce qui en fait la source officielle de référence. Si vous figurez dans la comptabilité du failli comme créancier connu, le curateur peut vous avoir adressé une notification directe par courrier recommandé — mais vous ne pouvez pas compter uniquement sur cette démarche.

Si vous avez des clients en difficulté, je vous recommande de les surveiller proactivement sur REGSOL : une consultation mensuelle suffit pour être alerté sans délai en cas de jugement.

---

## Je n'ai pas reçu de notification. Suis-je quand même tenu par le délai ?

Oui, sans exception. Le délai de 30 jours court à compter de la date du jugement de faillite, et non à partir du moment où vous en avez été informé. Le fait que vous ignoriez la faillite ne suspend pas ce délai et ne constitue pas une cause de relevé de forclusion. C'est précisément pour cette raison qu'il est utile de surveiller REGSOL régulièrement pour les clients dont vous percevez des signaux de fragilité : retards de paiement répétés, rumeurs de difficultés, procédures de réorganisation judiciaire en cours.
...
Pour connaître [les droits propres à votre situation](creanciers-categories.md) de travailleur créancier, la section dédiée vous donne toutes les informations utiles.
...
- [Les droits propres à votre situation](creanciers-categories.md) : travailleurs, fournisseurs, créanciers publics.
